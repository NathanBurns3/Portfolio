    ...
    return [
      {
        ...
        projectDescription: [
          'Built a full stack fitness tracking app with MEAN stack (MongoDB, Express.js, Angular, Node.js), implementing JWT-based authentication, user data caching, and an algorithm for personalized macro plans',
          ...
          'Conducted API testing with Postman, styled the app using Tailwind CSS, utilized RxJS for reactive programming, and created unit tests with Jest to ensure functionality. Added cron automation for periodically updating user data',
